function THETA_l = THETA_loss(Omega,Ain,Bin,epsilon,ka_in,ka_out,ka_l,kb_in,kb_out,kb_l,Delta_a,Delta_b,varargin)
%
% Computes the 
% Theta_l Computes the THETA_loss Matrix from 
% Mout, Mc and Lambda matrices. This encapsultes the steady state a
% fluctuating elements of cavity loss.
%
...
%
% Output:
%   [THETA_l] = 4x4 matrix, containing the loss elements for working out
%   X_refl, and X_refl_phi later
%
% Input: 
...
% The individual mirror coupling rate matrixes
 ...
 THETA_l = LambdaMat*Min*inv(1i.*Omega.*eye(4)-Mc)*Ml*inv(LambdaMat);