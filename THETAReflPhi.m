function [THETA_in, THETA_out, THETA_loss, THETA_Delta, THETA_epsilon] = THETAReflPhi(Omega,Ain,Bin,epsilon,ka_in,ka_out,ka_l,kb_in,kb_out,kb_l,Delta_a,Delta_b,phi,varargin)
%
%
